    ...
    await queryInterface.bulkInsert(
      ...
      [
        ...
        },
        {
          ...
          description: `
        Join us for a stimulating session where we 
        ...
        },
        {
          ...
          description: `
        In this months botany lession we will finally begin addressing 
        how to care for our beautiful flowers. Flowers come in all 
        shapes and sizes, each one requiring a different techique to acheive 
        the optimal bloom. We will split into two sections and break for lunch in 
        between. Many flowers have multiple blooms so please join both 
        sections if you can. 
         `,
          type: "In Person",
          capacity: 30,
