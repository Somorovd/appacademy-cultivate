  ...
  async up(queryInterface, Sequelize) {
    ...
    await queryInterface.bulkInsert(
      ...
      [
        ...
        is not requirement, but we'll be sure to get you into one ASAP
        ...
        },
        {
          ...
          about: `
        There is much to learn about the beauty of nature and the mysteries of 
        divine fertility. The seed of life is delicate and requires a knowledgable 
        hand to guide it on its journey. The effort is great, but the results are
        euphoric. Join now to prepare for our next years beautiful and bountiful 
        harvest. 
        `,
          type: "In Person",
          private: false,
